...
**Key artifact:** `verification_plan.toml`, managed via MCP server to prevent silent data corruption. Current state: 28 complete, 1 in_progress (REQ-021, bit error only), 8 not_started (REQ-001–005 LLC deferred, REQ-034 MAC deferred, REQ-035 P2 non-blocking, REQ-036 LLC deferred).
