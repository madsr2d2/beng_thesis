...
add wave -vgroup "can_fce_tb :: TB" \
	...
	( -logic /can_fce_tb/mac_i/passive_tx_ack_error_exempt_1 ) \
	...
	( -decimal /can_fce_tb/bus_off ) \
	( -decimal /can_fce_tb/bus_off_recovery ) \
	( -decimal /can_fce_tb/rule_a ) \
	( -decimal /can_fce_tb/rule_b ) \
	( -decimal /can_fce_tb/rule_c_d ) \
	( -decimal /can_fce_tb/rule_e ) \
	( -decimal /can_fce_tb/rule_f ) \
	( -decimal /can_fce_tb/rule_g ) \
	( -decimal /can_fce_tb/rule_h ) \
...
add wave -vgroup "u_dut :: inputs" \
	...
	( -logic /can_fce_tb/u_dut/mac_i/passive_tx_ack_error_exempt_1 ) \
...
add wave -vgroup "u_dut :: internals" \
	...
	( -decimal /can_fce_tb/u_dut/receiver_error_count ) \
