...
add wave -vgroup "can_mac_tb :: TB" \
	...
	( -logic /can_mac_tb/tx_pcs_i/bus_polarity ) \
	...
	( -logic /can_mac_tb/tx_pcs_o/polarity ) \
	...
	( -logic /can_mac_tb/rx_pcs_i/bus_polarity ) \
	...
	( -logic /can_mac_tb/rx_pcs_o/polarity ) \
...
add wave -vgroup "u_mac_tx :: inputs" \
	...
	( -logic /can_mac_tb/u_mac_tx/pcs_i/bus_polarity ) \
...
add wave -vgroup "u_mac_tx :: outputs" \
	...
	( -logic /can_mac_tb/u_mac_tx/pcs_o/polarity ) \
	( -logic /can_mac_tb/u_mac_tx/pcs_o/use_data_rate ) \
	( -logic /can_mac_tb/u_mac_tx/pcs_o/start_tdc ) \
...
add wave -vgroup "u_mac_tx/u_can_mac_fsm_tx :: inputs" \
	...
	( -logic /can_mac_tb/u_mac_tx/u_can_mac_fsm_tx/pcs_i/bus_polarity ) \
...
add wave -vgroup "u_mac_tx/u_can_mac_fsm_tx :: outputs" \
	...
	( -logic /can_mac_tb/u_mac_tx/u_can_mac_fsm_tx/pcs_o/polarity ) \
	( -logic /can_mac_tb/u_mac_tx/u_can_mac_fsm_tx/pcs_o/use_data_rate ) \
	( -logic /can_mac_tb/u_mac_tx/u_can_mac_fsm_tx/pcs_o/start_tdc ) \
...
add wave -vgroup "u_mac_rx :: inputs" \
	...
	( -logic /can_mac_tb/u_mac_rx/pcs_i/bus_polarity ) \
...
add wave -vgroup "u_mac_rx :: outputs" \
	...
	( -logic /can_mac_tb/u_mac_rx/pcs_o/polarity ) \
	( -logic /can_mac_tb/u_mac_rx/pcs_o/use_data_rate ) \
	( -logic /can_mac_tb/u_mac_rx/pcs_o/start_tdc ) \
...
add wave -vgroup "u_mac_rx/u_can_mac_fsm_rx :: inputs" \
	...
	( -logic /can_mac_tb/u_mac_rx/u_can_mac_fsm_rx/pcs_i/bus_polarity ) \
...
add wave -vgroup "u_mac_rx/u_can_mac_fsm_rx :: outputs" \
	...
	( -logic /can_mac_tb/u_mac_rx/u_can_mac_fsm_rx/pcs_o/polarity ) \
	( -logic /can_mac_tb/u_mac_rx/u_can_mac_fsm_rx/pcs_o/use_data_rate ) \
	( -logic /can_mac_tb/u_mac_rx/u_can_mac_fsm_rx/pcs_o/start_tdc ) \
