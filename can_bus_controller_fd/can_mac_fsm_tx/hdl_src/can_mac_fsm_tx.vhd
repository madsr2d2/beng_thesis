...
begin
  ...
  p_fsm : process (clk_i) is
    ...
    variable v_monitored_bit_info : t_bit_info;
    ...
    begin
      ...
      if (v_tx_bit.bit_name /= stuff_bit) then
        v_bit_count := v_prepare_position;
    ...
    begin
      ...
      case v_monitored_bit_info.event_type is
        ...
        when none =>
          ...
          elsif (bs_fd_i.valid = '1' and bit_count < frame_params.dynamic_stuff_stop) then
            -- Inline stuff bit: write FIFO, drive PCS, feed stuffer and CRC
  ...
  begin
    ...
    if rising_edge(clk_i) then
      if (rst_i = '1') then
        ...
        v_monitored_bit_info := c_reset_bit_info;
        ...
        case state is
          ...
          when s_transmitting_frame =>
            ...
            if (prev_state /= state) then
              -- Initialize new frame transmission.
              -- When skip_sof is true (ISO 11898-1: 6.6.7.2 / 6.6.8), the SOF has
            ...
            elsif (bit_count = frame_params.crc_delimiter + c_eof_start_offset + c_eof_field_width) then
            ...
            -- Post-monitoring: arbitration lost or error handling.
