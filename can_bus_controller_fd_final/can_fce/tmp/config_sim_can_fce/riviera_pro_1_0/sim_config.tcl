...
#------------------------------------------------------------------------------#
set module_name "can_fce"
set dut_entity "u_dut*"
set test_bench_name "can_fce_tb"
...
set sim_wave_module_name "sim_wave_can_fce.tcl"
...
set work_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_fce/tmp/config_sim_can_fce/riviera_pro_1_0"

# Relative path to simulation coverage folder
set cov_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_fce/tmp/config_sim_can_fce/coverage_1_0"

# Point to testcase path
set test_case_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_fce/test_case"
...
set python_string_arg_t "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_fce/test_case/config_sim_can_fce.cfg"
...
dict set core_files glbl [dict create \
  verilog {
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_fce/tmp/config_sim_can_fce/riviera_pro_1_0/glbl.v"
  } \
]

dict set core_files can_fce [dict create \
  vhdl {
    ...
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_fce/hdl_tb/can_fce_tb.vhd"
  } \
]
