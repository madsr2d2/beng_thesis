...
#------------------------------------------------------------------------------#
set module_name "can_mac"
set dut_entity "u_dut*"
set test_bench_name "can_mac_tb"
...
set sim_wave_module_name "sim_wave_can_mac.tcl"
...
set work_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac/tmp/config_sim_can_mac/riviera_pro_1_0"

# Relative path to simulation coverage folder
set cov_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac/tmp/config_sim_can_mac/coverage_1_0"

# Point to testcase path
set test_case_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac/test_case"
...
set python_string_arg_t "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac/test_case/config_sim_can_mac.cfg"
...
dict set core_files glbl [dict create \
  verilog {
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac/tmp/config_sim_can_mac/riviera_pro_1_0/glbl.v"
  } \
]

dict set core_files can_mac [dict create \
  vhdl {
    ...
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_rx/hdl_src/can_mac_fsm_rx.vhd"
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_rx/hdl_src/can_mac_rx.vhd"
    ...
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac/hdl_tb/can_mac_tb.vhd"
  } \
]
