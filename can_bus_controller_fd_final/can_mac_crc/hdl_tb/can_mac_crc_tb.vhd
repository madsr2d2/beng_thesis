...
-- Requirements:  
--
-- Description:   Test bench for can_mac_crc.
...
--                p_output_stable_checker - Verifies CRC holds when valid de-asserted.
...
begin
  ...
  -- Frame reset OR'd with main reset for CRC re-initialization between frames
