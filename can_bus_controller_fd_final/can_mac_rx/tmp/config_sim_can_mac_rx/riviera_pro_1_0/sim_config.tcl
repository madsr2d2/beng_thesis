...
#------------------------------------------------------------------------------#
set module_name "can_mac_rx"
set dut_entity "u_dut*"
set test_bench_name "can_mac_rx_tb"
...
set sim_wave_module_name "sim_wave_can_mac_rx.tcl"
...
set work_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_rx/tmp/config_sim_can_mac_rx/riviera_pro_1_0"

# Relative path to simulation coverage folder
set cov_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_rx/tmp/config_sim_can_mac_rx/coverage_1_0"

# Point to testcase path
set test_case_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_rx/test_case"
...
set python_string_arg_t "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_rx/test_case/config_sim_can_mac_rx.cfg"
...
dict set core_files glbl [dict create \
  verilog {
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_rx/tmp/config_sim_can_mac_rx/riviera_pro_1_0/glbl.v"
  } \
]

dict set core_files can_mac_rx [dict create \
  vhdl {
    ...
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_rx/hdl_tb/can_mac_rx_tb.vhd"
  } \
]
