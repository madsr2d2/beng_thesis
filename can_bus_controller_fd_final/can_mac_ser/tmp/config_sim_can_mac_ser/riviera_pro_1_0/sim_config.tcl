...
#------------------------------------------------------------------------------#
set module_name "can_mac_ser"
set dut_entity "u_dut*"
set test_bench_name "can_mac_ser_tb"
...
set sim_wave_module_name "sim_wave_can_mac_ser.tcl"
...
set work_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser/tmp/config_sim_can_mac_ser/riviera_pro_1_0"

# Relative path to simulation coverage folder
set cov_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser/tmp/config_sim_can_mac_ser/coverage_1_0"

# Point to testcase path
set test_case_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser/test_case"
...
set python_string_arg_t "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser/test_case/config_sim_can_mac_ser.cfg"
...
dict set core_files glbl [dict create \
  verilog {
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser/tmp/config_sim_can_mac_ser/riviera_pro_1_0/glbl.v"
  } \
]

dict set core_files can_mac_ser [dict create \
  vhdl {
    ...
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser/hdl_tb/can_mac_ser_tb.vhd"
  } \
]
