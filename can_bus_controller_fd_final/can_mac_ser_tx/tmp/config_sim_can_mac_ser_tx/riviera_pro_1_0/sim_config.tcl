...
#------------------------------------------------------------------------------#
set module_name "can_mac_ser_tx"
set dut_entity "u_dut*"
set test_bench_name "can_mac_ser_tx_tb"
...
set sim_wave_module_name "sim_wave_can_mac_ser_tx.tcl"
...
set work_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser_tx/tmp/config_sim_can_mac_ser_tx/riviera_pro_1_0"

# Relative path to simulation coverage folder
set cov_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser_tx/tmp/config_sim_can_mac_ser_tx/coverage_1_0"

# Point to testcase path
set test_case_path "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser_tx/test_case"
...
set python_string_arg_t "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser_tx/test_case/config_sim_can_mac_ser_tx.cfg"
...
dict set core_files glbl [dict create \
  verilog {
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser_tx/tmp/config_sim_can_mac_ser_tx/riviera_pro_1_0/glbl.v"
  } \
]

dict set core_files can_mac_ser_tx [dict create \
  vhdl {
    ...
    "C:/git_folder/triton_func/modules/ip_lib/can_bus_controller_fd/can_mac_ser_tx/hdl_tb/can_mac_ser_tx_tb.vhd"
  } \
]
