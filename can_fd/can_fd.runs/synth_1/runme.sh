...
HD_PWD='/home/madsr2d2/beng_thesis/can_fd/can_fd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_mac_llc_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tx_mac_llc_ctrl.tcl
