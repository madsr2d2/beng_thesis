...
| [REQ-020]{#req-020 .req-id} | 6.6.10.2, 6.6.11.2, 6.6.17.4, 6.6.17.5, Figure 10, Figure 11, Figure 18, Figure 19 | P1 | **Bus arbitration** `\newline`{=latex} Recessive-sent, dominant-monitored: lose arbitration and become a receiver. |  |
...
| REQ-031 | MAC | both | FB, FE | white_box | code_inspection, waveform_inspection | complete | p_fsm:~636, p_fsm:~755, test_normal | can_mac_pcs_fce_tb |  |
