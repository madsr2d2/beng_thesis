...
- [**Key**](#key)
- [**Road vehicles — Controller area network (CAN) —**](#road-vehicles--controller-area-network-can-)
- [Part 1](#part-1)
- [**Data link layer and physical coding sublayer**](#data-link-layer-and-physical-coding-sublayer)
- [**1 Scope**](#1-scope)
...
- [**3.3**](#33)
- [**attachment unit interface**](#attachment-unit-interface)
- [**AUI**](#aui)
- [**3.4**](#34)
...
- [**bus-off**](#bus-off)
- [**3.10**](#310)
- [**classic base frame format**](#classic-base-frame-format)
- [**CBFF**](#cbff)
- [**3.11**](#311)
- [**classic extended frame format**](#classic-extended-frame-format)
- [**CEFF**](#ceff)
- [**3.12**](#312)
- [**classic frame**](#classic-frame)
- [**3.13**](#313)
- [**commander node**](#commander-node)
- [**3.14**](#314)
- [**data bit rate**](#data-bit-rate)
- [**3.15**](#315)
- [**data bit time**](#data-bit-time)
- [**3.16**](#316)
- [**data frame**](#data-frame)
- [**3.17**](#317)
- [**data phase**](#data-phase)
- [**3.18**](#318)
- [**data RX mode**](#data-rx-mode)
- [**3.19**](#319)
- [**data TX mode**](#data-tx-mode)
- [**3.20**](#320)
- [**edge**](#edge)
- [**3.21**](#321)
- [**error frame**](#error-frame)
- [**3.22**](#322)
- [**FD base frame format**](#fd-base-frame-format)
- [**FBFF**](#fbff)
- [**3.23**](#323)
- [**FD enabled**](#fd-enabled)
- [**3.24**](#324)
- [**FD extended frame format**](#fd-extended-frame-format)
- [**FEFF**](#feff)
- [**3.25**](#325)
- [**FD frame**](#fd-frame)
- [**3.26**](#326)
...
- [**ID**](#id)
- [**3.32**](#332)
- [**identifier-based arbitration**](#identifier-based-arbitration)
- [**3.33**](#333)
- [**idle**](#idle)
- [**3.34**](#334)
- [**idle condition**](#idle-condition)
- [**3.35**](#335)
- [**integrating**](#integrating)
- [**3.36**](#336)
- [**minimum time quantum**](#minimum-time-quantum)
- [**3.37**](#337)
...
- [node clock](#node-clock)
  - [3.41](#341)
- [nominal bit rate](#nominal-bit-rate)
  - [3.42](#342)
...
- [protocol](#protocol)
  - [3.47](#347)
- [protocol exception event](#protocol-exception-event)
  - [3.48](#348)
- [receiver](#receiver)
- [**3.49**](#349)
...
- [**3.51**](#351)
- [**stuff bit count**](#stuff-bit-count)
- [**3.52**](#352)
...
- [**XL frame**](#xl-frame)
- [**3.56**](#356)
- [**XL frame format**](#xl-frame-format)
- [**XLFF**](#xlff)
- [**4 Symbols and abbreviated terms**](#4-symbols-and-abbreviated-terms)
- [**5 Basic concepts of CAN**](#5-basic-concepts-of-can)
- [**5.1 CAN properties**](#51-can-properties)
- [**5.2 Frame transmissions**](#52-frame-transmissions)
- [**5.3 Bus access method**](#53-bus-access-method)
- [**5.4 Information routing**](#54-information-routing)
- [**5.5 Network flexibility**](#55-network-flexibility)
- [**5.6 Remote data request**](#56-remote-data-request)
- [**5.7 Error detection**](#57-error-detection)
- [**5.8 Error signalling and recovery time**](#58-error-signalling-and-recovery-time)
- [**5.9 Fault confinement**](#59-fault-confinement)
- [**5.10 Error-active**](#510-error-active)
- [**5.11 Error-passive**](#511-error-passive)
- [**5.12 Bus-off**](#512-bus-off)
- [**5.13 ACK**](#513-ack)
- [**5.14 Repetition of transmission attempts**](#514-repetition-of-transmission-attempts)
- [**5.15 Network-wide data consistency**](#515-network-wide-data-consistency)
- [**5.16 Switchable operating modes of the PMA**](#516-switchable-operating-modes-of-the-pma)
- [**5.17 Bus states and MAC sub-layer phases**](#517-bus-states-and-mac-sub-layer-phases)
- [**6 CAN DLL specification**](#6-can-dll-specification)
- [**6.1 General**](#61-general)
- [**6.2 Time stamping**](#62-time-stamping)
- [**6.3 DLL protocol**](#63-dll-protocol)
- [**6.4 LLC sub-layer**](#64-llc-sub-layer)
- [**6.4.1 Overview**](#641-overview)
- [**6.4.2 Notifications**](#642-notifications)
- [**6.4.3 Structure of LLC frames**](#643-structure-of-llc-frames)
- [**Table 4** *(continued)*](#table-4-continued)
- [**6.4.4 Limited LLC frames**](#644-limited-llc-frames)
- [**6.4.5 Services of LLC sub-layer**](#645-services-of-llc-sub-layer)
- [**6.4.5.1 Service access points**](#6451-service-access-points)
- [**6.4.5.2 Types of connectionless-mode transmission services**](#6452-types-of-connectionless-mode-transmission-services)
- [**6.4.5.3 Format description of service primitives**](#6453-format-description-of-service-primitives)
- [**6.4.5.4 Types of services**](#6454-types-of-services)
- [**6.4.5.5 Service specification**](#6455-service-specification)
- [**6.4.5.5.1 General**](#64551-general)
- [**Table 6 — LLC services overview**](#table-6--llc-services-overview)
- [**Table 7 — LLC service parameters**](#table-7--llc-service-parameters)
- [**6.4.5.5.2 L\_Data.Request**](#64552-l_datarequest)
- [**Function**](#function)
- [**Semantics of L\_Data.Request service**](#semantics-of-l_datarequest-service)
- [**Effect on receipt**](#effect-on-receipt)
- [**6.4.5.5.3 L\_Data.AbortRequest**](#64553-l_dataabortrequest)
- [**Function**](#function-1)
- [**Semantics of L\_Data.AbortRequest service**](#semantics-of-l_dataabortrequest-service)
- [**Effect on receipt**](#effect-on-receipt-1)
- [**6.4.5.5.4 L\_Data.Confirm**](#64554-l_dataconfirm)
- [**Function**](#function-2)
- [**Semantics of L\_Data.Confirm service**](#semantics-of-l_dataconfirm-service)
- [**Effect on receipt**](#effect-on-receipt-2)
- [**6.4.5.5.5 L\_Data.indication**](#64555-l_dataindication)
- [**Function**](#function-3)
- [**Semantics of L\_Data.Indication service**](#semantics-of-l_dataindication-service)
- [**Effect on receipt**](#effect-on-receipt-3)
- [**6.5 Functions of the LLC sub-layer**](#65-functions-of-the-llc-sub-layer)
- [**6.5.1 General**](#651-general)
- [**6.5.2 Flow control on re-arbitration**](#652-flow-control-on-re-arbitration)
- [**6.5.3 Flow control on retransmission**](#653-flow-control-on-retransmission)
- [**6.5.4 Frame acceptance filtering**](#654-frame-acceptance-filtering)
- [**6.5.5 Overload notification**](#655-overload-notification)
- [**6.5.6 Recovery management**](#656-recovery-management)
- [**6.5.7 Time stamping**](#657-time-stamping)
- [**6.6 MAC sub-layer**](#66-mac-sub-layer)
- [**6.6.1 Functions and rules**](#661-functions-and-rules)
- [**6.6.2 Services of the MAC sub-layer**](#662-services-of-the-mac-sub-layer)
- [**6.6.3 Time reference points**](#663-time-reference-points)
- [**6.6.4 Functional model of MAC sub-layer architecture**](#664-functional-model-of-mac-sub-layer-architecture)
- [**6.6.4.1 Capability**](#6641-capability)
- [**6.6.4.2 MAC frame transmission**](#6642-mac-frame-transmission)
- [**Transmit data encapsulation:**](#transmit-data-encapsulation)
- [**Transmit medium access management:**](#transmit-medium-access-management)
- [**6.6.4.3 MAC frame reception**](#6643-mac-frame-reception)
- [**Receive medium access management:**](#receive-medium-access-management)
- [**Receive data de-capsulation:**](#receive-data-de-capsulation)
- [**6.6.4.4 MAC CRC calculation**](#6644-mac-crc-calculation)
- [**6.6.5 Specification of EF**](#665-specification-of-ef)
- [**6.6.5.1 Description**](#6651-description)
- [**6.6.5.2 Error flag**](#6652-error-flag)
- [**6.6.5.3 Error delimiter**](#6653-error-delimiter)
- [**6.6.6 Specification of OF**](#666-specification-of-of)
- [**6.6.6.1 Types**](#6661-types)
- [**6.6.6.2 Overload flag**](#6662-overload-flag)
- [**6.6.6.3 Overload delimiter**](#6663-overload-delimiter)
- [**6.6.7 Inter-frame space specification**](#667-inter-frame-space-specification)
- [**6.6.7.1 Separation of frames**](#6671-separation-of-frames)
- [**6.6.7.2 Intermission**](#6672-intermission)
- [**6.6.7.3 Bus idle**](#6673-bus-idle)
- [**6.6.7.4 Suspend transmission**](#6674-suspend-transmission)
- [**6.6.7.5 Bus re-integration**](#6675-bus-re-integration)
- [**6.6.8 SOF**](#668-sof)
- [**6.6.9 Elements of the MAC frame**](#669-elements-of-the-mac-frame)
- [**6.6.10 MAC frame in CBFF and CEFF**](#6610-mac-frame-in-cbff-and-ceff)
- [**6.6.10.1 General**](#66101-general)
- [**6.6.10.2 Arbitration field**](#66102-arbitration-field)
- [**Arbitration**](#arbitration)
- [**SRR bit**](#srr-bit)
- [**6.6.10.3 Control field**](#66103-control-field)
- [**IDE / r1**](#ide--r1)
- [**r0**](#r0)
- [**DLC**](#dlc)
- [**6.6.10.4 Data field**](#66104-data-field)
- [**6.6.10.5 CRC field**](#66105-crc-field)
- [**FCRC sequence**](#fcrc-sequence)
- [**CRC delimiter**](#crc-delimiter)
- [**6.6.10.6 ACK field**](#66106-ack-field)
- [**ACK slot**](#ack-slot)
- [**ACK delimiter**](#ack-delimiter)
- [**6.6.10.7 EOF**](#66107-eof)
- [**6.6.11 MAC frame in FBFF and FEFF**](#6611-mac-frame-in-fbff-and-feff)
- [**6.6.11.1 General**](#66111-general)
- [**6.6.11.2 Arbitration field**](#66112-arbitration-field)
- [**Arbitration**](#arbitration-1)
- [**SRR bit**](#srr-bit-1)
- [**RRS bit**](#rrs-bit)
- [**6.6.11.3 Control field**](#66113-control-field)
- [**FDF**](#fdf)
- [**res**](#res)
- [**BRS**](#brs)
- [**ESI**](#esi)
- [**DLC**](#dlc-1)
- [**6.6.11.4 Data field**](#66114-data-field)
- [**6.6.11.5 CRC field**](#66115-crc-field)
- [**Stuff count**](#stuff-count)
- [**FCRC sequence**](#fcrc-sequence-1)
- [**CRC delimiter**](#crc-delimiter-1)
- [**6.6.11.6 ACK field**](#66116-ack-field)
- [**ACK slot**](#ack-slot-1)
- [**ACK delimiter**](#ack-delimiter-1)
- [**6.6.11.7 EOF**](#66117-eof)
- [**6.6.12 MAC frame in XLFF**](#6612-mac-frame-in-xlff)
- [**6.6.12.1 General**](#66121-general)
- [**6.6.12.2 Arbitration field**](#66122-arbitration-field)
- [**Arbitration**](#arbitration-2)
- [**RRS bit**](#rrs-bit-1)
- [**IDE bit**](#ide-bit)
- [**FDF bit**](#fdf-bit)
- [**XLF bit**](#xlf-bit)
- [**6.6.12.3 Control field**](#66123-control-field)
- [**resXL bit**](#resxl-bit)
- [**ADS**](#ads)
- [**Bit rate switching**](#bit-rate-switching)
- [**CAN transceiver mode change**](#can-transceiver-mode-change)
...
- [**VCID**](#vcid)
- [**AF**](#af)
- [**6.6.12.4 Data field**](#66124-data-field)
- [**6.6.12.5 CRC field**](#66125-crc-field)
- [**FCP sequence**](#fcp-sequence)
- [**6.6.12.6 ACK field**](#66126-ack-field)
- [**DAS**](#das)
- [**Bit rate switching**](#bit-rate-switching-1)
- [**CAN transceiver mode change to arbitration mode**](#can-transceiver-mode-change-to-arbitration-mode)
- [**ACK slot**](#ack-slot-2)
- [**ACK delimiter**](#ack-delimiter-2)
- [**6.6.12.7 EOF**](#66127-eof)
- [**6.6.13 MAC frame coding**](#6613-mac-frame-coding)
- [**6.6.13.1 Coding requirements**](#66131-coding-requirements)
- [**6.6.13.2 Dynamic bit stuffing**](#66132-dynamic-bit-stuffing)
- [**6.6.13.3 Fixed bit stuffing**](#66133-fixed-bit-stuffing)
- [**6.6.13.3.1 CAN FD CRC field**](#661331-can-fd-crc-field)
- [**6.6.13.3.2 CAN XL data phase**](#661332-can-xl-data-phase)
- [**6.6.14 Data frame acknowledgement**](#6614-data-frame-acknowledgement)
- [**6.6.15 Frame validation**](#6615-frame-validation)
- [**6.6.15.1 General**](#66151-general)
- [**6.6.15.2 Behaviour when error signalling is enabled**](#66152-behaviour-when-error-signalling-is-enabled)
- [**Receiver**](#receiver-1)
- [**Transmitter**](#transmitter-1)
- [**6.6.15.3 Behaviour when error signalling is disabled**](#66153-behaviour-when-error-signalling-is-disabled)
- [**6.6.16 Order of bit transmission**](#6616-order-of-bit-transmission)
- [**6.6.17 Medium access method**](#6617-medium-access-method)
- [**6.6.17.1 Bus access**](#66171-bus-access)
- [**6.6.17.2 Protocol exception event**](#66172-protocol-exception-event)
- [**6.6.17.3 Transmission of MAC frames**](#66173-transmission-of-mac-frames)
- [**6.6.17.4 Identifier based arbitration**](#66174-identifier-based-arbitration)
- [**6.6.17.5 Frame priority**](#66175-frame-priority)
- [**6.6.17.6 Collision resolution**](#66176-collision-resolution)
- [**6.6.18 MAC data consistency**](#6618-mac-data-consistency)
- [**6.6.19 Restricted operation**](#6619-restricted-operation)
- [**6.6.20 Bus monitoring**](#6620-bus-monitoring)
- [**6.6.21 Error handling and overload handling**](#6621-error-handling-and-overload-handling)
- [**6.6.21.1 Control of error signalling**](#66211-control-of-error-signalling)
- [**6.6.21.2 Error detection**](#66212-error-detection)
- [a) **Bit error**](#a-bit-error)
- [b) **Stuff error**](#b-stuff-error)
- [c) **PCRC error and frame CRC error**](#c-pcrc-error-and-frame-crc-error)
- [d) **Form error**](#d-form-error)
- [e) **ACK error**](#e-ack-error)
- [**6.6.21.3 Behaviour when error signalling is enabled**](#66213-behaviour-when-error-signalling-is-enabled)
- [**6.6.21.3.1 Error handling**](#662131-error-handling)
- [**6.6.21.3.2 Overload signalling**](#662132-overload-signalling)
- [**6.6.21.3.3 Restricted operation**](#662133-restricted-operation)
- [**6.6.21.3.4 Error counting**](#662134-error-counting)
- [**6.6.21.4 Behaviour when error signalling is disabled**](#66214-behaviour-when-error-signalling-is-disabled)
- [**6.6.21.4.1 General**](#662141-general)
- [**6.6.21.4.2 Error handling**](#662142-error-handling)
- [**Transmitter errors**](#transmitter-errors)
- [**Receiver errors**](#receiver-errors)
- [**6.6.21.4.3 Overload signalling**](#662143-overload-signalling)
- [**6.6.21.4.4 Restricted operation**](#662144-restricted-operation)
- [**6.6.21.4.5 Error counting**](#662145-error-counting)
- [**7 PL specifications**](#7-pl-specifications)
- [**7.1 General and functional modelling**](#71-general-and-functional-modelling)
- [**7.2 Services of the PCS interface**](#72-services-of-the-pcs-interface)
- [**7.2.1 Requirements**](#721-requirements)
- [**7.2.2 PCS\_Data.Request**](#722-pcs_datarequest)
- [**7.2.3 PCS\_Data.Indicate**](#723-pcs_dataindicate)
- [**7.2.4 PCS\_Mode.Request**](#724-pcs_moderequest)
- [**7.2.5 PCS\_Status.Transmitter**](#725-pcs_statustransmitter)
- [**7.2.6 PCS\_Status.Receiver**](#726-pcs_statusreceiver)
- [**7.3 PCS**](#73-pcs)
- [**7.3.1 Bit encoding/decoding**](#731-bit-encodingdecoding)
- [**7.3.2 Bit time**](#732-bit-time)
- [Time quantum](#time-quantum)
- [Bit rates and bit times](#bit-rates-and-bit-times)
- [**Sync\_Seg**](#sync_seg)
- [**Prop\_Seg**](#prop_seg)
- [**Phase\_Seg1, Phase\_Seg2**](#phase_seg1-phase_seg2)
- [**Sample point**](#sample-point)
- [**Information processing time**](#information-processing-time)
- [**Synchronization jump width (SJW)**](#synchronization-jump-width-sjw)
- [**Internal delay time**](#internal-delay-time)
  - [7.3.3 Configuration of the bit time parameters](#733-configuration-of-the-bit-time-parameters)
    - [7.3.4 Transmitter delay compensation](#734-transmitter-delay-compensation)
    - [7.3.5 Synchronization](#735-synchronization)
      - [7.3.5.1 Description](#7351-description)
- [**7.3.5.2 Phase error of an edge**](#7352-phase-error-of-an-edge)
  - [7.3.5.3 Hard synchronization](#7353-hard-synchronization)
    - [7.3.5.4 Bit resynchronization](#7354-bit-resynchronization)
    - [7.3.6 Tolerance range of the oscillator frequencies](#736-tolerance-range-of-the-oscillator-frequencies)
  - [7.4 Attachment unit interface](#74-attachment-unit-interface)
    - [7.4.1 General](#741-general)
    - [7.4.2 PCS to PMA symbols](#742-pcs-to-pma-symbols)
      - [7.4.2.1 Output symbol](#7421-output-symbol)
      - [7.4.2.2 Bus\_off symbol](#7422-bus_off-symbol)
      - [7.4.2.3 Bus\_off\_release symbol](#7423-bus_off_release-symbol)
      - [7.4.2.4 Mode symbol](#7424-mode-symbol)
      - [7.4.2.5 D\_Transmit symbol](#7425-d_transmit-symbol)
      - [7.4.2.6 D\_Receive symbol](#7426-d_receive-symbol)
    - [7.4.3 PMA to PCS symbol](#743-pma-to-pcs-symbol)
  - [7.5 PWM encoding](#75-pwm-encoding)
    - [7.5.1 General function and definitions](#751-general-function-and-definitions)
    - [7.5.2 PCS without PWM encoding](#752-pcs-without-pwm-encoding)
    - [7.5.3 PCS sub-layer with PWM encoding](#753-pcs-sub-layer-with-pwm-encoding)
      - [7.5.3.1 PWM encoding activation and deactivation](#7531-pwm-encoding-activation-and-deactivation)
      - [7.5.3.2 Internal processing delay](#7532-internal-processing-delay)
      - [7.5.3.3 PWM configuration](#7533-pwm-configuration)
- [**7.5.3.4 Transmitter**](#7534-transmitter)
- [**7.5.3.5 Receiver**](#7535-receiver)
- [**8 Description of supervisor FCE**](#8-description-of-supervisor-fce)
- [**8.1 Fault confinement**](#81-fault-confinement)
- [**8.1.1 Objectives**](#811-objectives)
- [**8.1.2 Strategies**](#812-strategies)
- [**8.1.3 Fault confinement interface specification**](#813-fault-confinement-interface-specification)
- [**8.1.3.1 Description**](#8131-description)
- [**8.1.3.2 LLC sub-layer/FCE interface**](#8132-llc-sub-layerfce-interface)
- [**Table 14 — LLC-to-FCE service interface**](#table-14--llc-to-fce-service-interface)
- [**Table 15 — FCE-to-LLC service interface**](#table-15--fce-to-llc-service-interface)
- [**8.1.3.3 MAC sub-layer/FCE interface**](#8133-mac-sub-layerfce-interface)
- [**Table 16 — MAC-to-FCE service interface**](#table-16--mac-to-fce-service-interface)
- [**Table 17 — FCE-to-MAC service interface**](#table-17--fce-to-mac-service-interface)
- [**8.1.3.4 PL/FCE interface**](#8134-plfce-interface)
- [**Table 18 — FCE-to-PL service interface**](#table-18--fce-to-pl-service-interface)
- [**Table 19 — PL-to-FCE service interface**](#table-19--pl-to-fce-service-interface)
- [**8.1.4 Rules of fault confinement**](#814-rules-of-fault-confinement)
- [**8.1.4.1 Description**](#8141-description)
- [**8.1.4.2 Error counting**](#8142-error-counting)
- [**8.1.4.3 Transition between error-active and error-passive states**](#8143-transition-between-error-active-and-error-passive-states)
- [**8.1.4.4 Bus-off management**](#8144-bus-off-management)
- [**8.1.5 Node start-up**](#815-node-start-up)
- [**8.2 Bus failure management**](#82-bus-failure-management)
- [**Annex A**](#annex-a)
- [**CAN FD light — Data link layer and physical coding sub-layer requirements of responder nodes**](#can-fd-light--data-link-layer-and-physical-coding-sub-layer-requirements-of-responder-nodes)
- [**A.1 Basic concepts of CAN FD light**](#a1-basic-concepts-of-can-fd-light)
- [**A.1.1 General**](#a11-general)
- [**A.1.2 Bus access method**](#a12-bus-access-method)
- [**A.1.3 ACK**](#a13-ack)
- [**A.1.4 Error detection and signalling**](#a14-error-detection-and-signalling)
- [**A.2 Data link layer requirements of the responder node**](#a2-data-link-layer-requirements-of-the-responder-node)
- [**A.2.1 Requirements of LLC sub-layer**](#a21-requirements-of-llc-sub-layer)
- [**A.2.1.1 Services of LLC sub-layer**](#a211-services-of-llc-sub-layer)
- [**A.2.1.1.1 General**](#a2111-general)
- [**A.2.1.1.2 Unacknowledged data transfer service**](#a2112-unacknowledged-data-transfer-service)
- [**A.2.1.2 Functions of LLC sub-layer**](#a212-functions-of-llc-sub-layer)
- [**A.2.1.3 Structure of LLC frames**](#a213-structure-of-llc-frames)
- [**A.2.2 Requirements of MAC sub-layer**](#a22-requirements-of-mac-sub-layer)
- [**A.2.2.1 Services of MAC sub-layer**](#a221-services-of-mac-sub-layer)
- [**A.2.2.2 Functional model of MAC sub-layer architecture**](#a222-functional-model-of-mac-sub-layer-architecture)
- [**A.2.2.2.1 Functions**](#a2221-functions)
- [**A.2.2.2.2 Frame transmission**](#a2222-frame-transmission)
- [**A.2.2.2.3 Frame reception**](#a2223-frame-reception)
- [**A.2.2.3 Structure of MAC frames**](#a223-structure-of-mac-frames)
- [**A.2.2.3.1 Description**](#a2231-description)
- [**A.2.2.3.2 Requirements of MAC DF**](#a2232-requirements-of-mac-df)
- [**A.2.2.3.2.1 SOF**](#a22321-sof)
- [**A.2.2.3.2.2 Arbitration field**](#a22322-arbitration-field)
- [**A.2.2.3.2.3 Control field**](#a22323-control-field)
- [**BRS bit**](#brs-bit)
- [**ESI bit**](#esi-bit)
- [**A.2.2.3.2.4 Data field**](#a22324-data-field)
- [**A.2.2.3.2.5 CRC field**](#a22325-crc-field)
- [**A.2.2.3.2.6 ACK field**](#a22326-ack-field)
- [**A.2.2.3.2.7 EOF**](#a22327-eof)
- [**A.2.2.4 Specification of inter-frame space**](#a224-specification-of-inter-frame-space)
- [**A.2.2.4.1 Definition**](#a2241-definition)
- [**A.2.2.4.2 Intermission field**](#a2242-intermission-field)
- [**A.2.2.4.3 Bus idle**](#a2243-bus-idle)
- [**A.2.2.4.4 Suspend transmission**](#a2244-suspend-transmission)
- [**A.2.2.5 Frame coding**](#a225-frame-coding)
- [**A.2.2.6 Frame ACK**](#a226-frame-ack)
- [**A.2.2.7 Frame validation**](#a227-frame-validation)
- [**A.2.2.8 Order of bit transmission**](#a228-order-of-bit-transmission)
- [**A.2.2.9 Medium access method**](#a229-medium-access-method)
- [**A.2.2.9.1 Bus access**](#a2291-bus-access)
- [**A.2.2.9.2 Bus integration state**](#a2292-bus-integration-state)
- [**A.2.2.9.3 Protocol exception event**](#a2293-protocol-exception-event)
- [**A.2.2.9.4 Collision handling**](#a2294-collision-handling)
- [**A.2.2.10 MAC data consistency**](#a2210-mac-data-consistency)
- [**A.2.2.11 Error handling**](#a2211-error-handling)
- [**A.2.2.11.1 General**](#a22111-general)
- [**A.2.2.11.2 Error detection**](#a22112-error-detection)
- [**A.2.2.11.3 Error handling and signalling**](#a22113-error-handling-and-signalling)
- [**A.2.2.12 Overload signalling**](#a2212-overload-signalling)
- [**A.3 Physical layer requirements of the responder node**](#a3-physical-layer-requirements-of-the-responder-node)
- [**A.3.1 Services of PL**](#a31-services-of-pl)
- [A.3.2 PCS specification](#a32-pcs-specification)
- [A.3.2.1 Bit encoding/decoding](#a321-bit-encodingdecoding)
- [A.3.2.2 Synchronization](#a322-synchronization)
- [A.3.2.2.1 Requirements](#a3221-requirements)
- [A.3.2.2.2 Tolerance range of the oscillator frequencies](#a3222-tolerance-range-of-the-oscillator-frequencies)
- [A.3.3 AUI specification](#a33-aui-specification)
- [A.3.3.1 PCS to PMA symbols](#a331-pcs-to-pma-symbols)
- [A.3.3.2 PMA to PCS symbol](#a332-pma-to-pcs-symbol)
- [A.4 Description of supervisor fault confinement](#a4-description-of-supervisor-fault-confinement)
- [A.5 Disabling ACK and transmitter synchronization](#a5-disabling-ack-and-transmitter-synchronization)
- [**Annex B** (informative)](#annex-b-informative)
- [**Configuration interface**](#configuration-interface)
- [**Annex C** (informative)](#annex-c-informative)
- [**Additional information**](#additional-information)
- [**C.1 Differences between CC frames, FD frames and XL frames**](#c1-differences-between-cc-frames-fd-frames-and-xl-frames)
- [**C.2 Implementation hints**](#c2-implementation-hints)
...
The ISO 11898 series provides requirement specifications for the controller area network (CAN) data link layer and physical layer. It is intended for chip implementers, e.g. this document can be used for CAN protocol controllers and ISO 11898-2 for CAN transceivers. The CAN data link layer models the open systems interconnection (OSI) data link layer; it is internally subdivided into logic link control (LLC) and medium access control (MAC). This document also specifies the physical coding sub-layer (PCS) by means of the attachment unit interface (AUI). The PCS also provides the pulse-with modulation (PWM) encoding to be linked to a CAN SIC XL transceiver, which provides the PWM decoding.
...
* ISO Online browsing platform: available at [https://www.iso.org/](https://www.iso.org/obp)obp
...
*t*q time quantum/time quanta
*t*q.min minimum time quantum
...
Figure 2 shows the DFs and RFs specified in this document. This figure is also provided in electronic form at: [https://standards.iso.org/iso/11898/-1/ed-3/en.](https://standards.iso.org/iso/11898/-1/ed-3/en)

![Image](_page_15_Figure_1.jpeg)
...
**CAN transceiver modes signalled to the PMA sub-layer PMA operating modes for CAN SIC XL transceivers as specified in ISO 11898-2** Arbitration mode SIC mode Data TX mode FAST TX mode Data RX mode FAST RX mode
...
![Image](_page_19_Figure_3.jpeg)

![Image](_page_19_Figure_4.jpeg)
...
The DLL may have a cross-layer function interface to a time-base for the time-stamping. When the timestamping is not supported, time-base and time-stamps shall be treated as constant with the value 0.
...
The LLC frame structure shall contain all content needed for all CAN frame formats and types, including the selection of a specific CAN frame format. In the interaction between the LLC sub-layer and the MAC sublayer, the content of that parts of the LLC frame that are not used for the selected CAN frame format shall be ignored. Only LLC frames with the LLC format specified in Table 4 can be transferred to the LLC sub-layer.
**Table 4 — LLC frame**
...
|  | 3 bit | The frame format is coded by the three bits IDE, FDF, and XLF: |
|  |  | — if 000b the MAC frame format is CBFF; |
|  |  | — if 100b the MAC frame format is CEFF; |
| Format |  | — if 010b the MAC frame format is FBFF; |
|  |  | — if 110b the MAC frame format is FEFF; |
|  |  | — if 011b the MAC frame format is XLFF. |
|  |  | Other bit values do not code a valid frame format. |
| FTYP | 1 bit | In CBFF and CEFF, the FTYP bit corresponds to the MAC frame's RTR bit, this means that FTYP distinguishes between the frame types RF (FTYP = 1b) and DF (FTYP = 0b). In FBFF and FEFF, the FTYP bit is ignored for transmission but corresponds to the MAC frame's RRS bit for reception. In XLFF, the FTYP bit corresponds to the MAC frame's RRS bit. |
...
| DLC | (7+4) bit | Data length code: 7 MSB only used in XLFF frames. For XLFF frames the numbers 0 to 2047 code 1 to 2048 data bytes. For DFs of all other formats the 4 LSB encode the number or data bytes as specified in Table 5. |
...
* Unacknowledged data transfer service This service provides means by which LLC users exchange LSDU without establishing a data link connection.
* Unacknowledged remote data request service This service provides means used by an LLC user to request a remote node for an LSDU transmission without establishing a data link connection.
...
where service indicates the name of the service, e.g. L_Data for data transfer;
...
| Unacknowledged data transfer | L_Data.Confirm | Confirmation of data transfer request |
...
$$\begin{array}{lll} \text{CRC\_13} & 39\text{E7}_{16} & (x^{13} + x^{12} + x^{11} + x^{8} + x^{7} + x^{6} + x^{5} + x^{2} + x^{1} + 1) \\ & = (x+1) \times (x^{12} + x^{10} + x^{9} + x^{8} + x^{6} + x^{4} + x^{3} + x^{2} + 1) \\ \text{CRC\_15} & \text{C599}_{16} & (x^{15} + x^{14} + x^{10} + x^{8} + x^{7} + x^{4} + x^{3} + 1) \\ & = (x+1) \times (x^{7} + x^{3} + 1) \times (x^{7} + x^{3} + x^{2} + x^{1} + 1) \\ \text{CRC\_17} & 3685\text{B}_{16} & (x^{17} + x^{16} + x^{14} + x^{13} + x^{11} + x^{6} + x^{4} + x^{3} + x^{1} + 1) \\ & = (x+1) \times (x^{16} + x^{13} + x^{10} + x^{9} + x^{8} + x^{7} + x^{6} + x^{3} + 1) \\ \text{CRC\_21} & 302899_{16} & (x^{21} + x^{20} + x^{13} + x^{11} + x^{7} + x^{4} + x^{3} + 1) \\ & = (x+1) \times (x^{10} + x^{3} + 1) \times (x^{10} + x^{3} + x^{2} + x^{14} + 1) \\ \text{CRC\_32} & 1\text{F4ACFB13}_{16} & (x^{32} + x^{31} + x^{30} + x^{29} + x^{28} + x^{26} + x^{23} + x^{21} + x^{19} + x^{18} + x^{15} + x^{14} + x^{13} + x^{11} + x^{9} + x^{8} + x^{4} + x^{1+1}) \\ & = (x+1) (x+1) (x^{15} + x^{4} + 1) (x^{15} + x^{14} + x^{11} + x^{6} + x^{4} + x^{3} + x^{2} + x^{1+1}) \end{array}$$
...
In order to carry out the CRC calculation, the polynomial to be divided is defined by the coefficients of the relevant bit stream. This polynomial is divided (the coefficients are calculated modulo-2) by the generatorpolynomial.
...
CRC\_RG(nCRC -1: 0) = CRC\_INIT\_VECTOR; //initialize shift register
REPEAT
...
![Image](_page_35_Figure_18.jpeg)
**Figure 8 — MAC DF**

![Image](_page_35_Figure_20.jpeg)
**Figure 9 — MAC RF**
...
![Image](_page_36_Figure_8.jpeg)
**Figure 10 — SOF and arbitration field of CBFF data frame**

![Image](_page_36_Figure_10.jpeg)
**Figure 11 — SOF and arbitration field of CBFF remote frame**

|  | Arbitration field |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | Base identifier |  |  |  |  |  |  | Identifi | er exten | sion |  |  |
| SOF | ID(28) ID(27) ID(19) ID(18) |  |  |  | SRR | IDE | ID(17) | ID(16) |  | ID(1) | ID(0) | RTR |

**Figure 12 — SOF and arbitration field of CEFF data frame**

|  | Arbitration field |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | Base |  |  |  | Identifi | er exten | sion |  |  |  |  |
| SOF | ID(28) ID(27) ID(19) ID(18) |  |  | SRR | IDE | ID(17) | ID(16) |  | ID(1) | ID(0) | RTR |
...
![Image](_page_38_Picture_12.jpeg)
...
![Image](_page_39_Picture_17.jpeg)
...
![Image](_page_40_Picture_1.jpeg)
**Figure 21 — Control field in FEFF**
...
In FD frames, the stuff count shall be at the beginning of the CRC field. It shall represent a number in the range from 0 to 7d (Gray-coded in SBC3, SBC2, and SBC1; followed by the parity bit SBC0) as specified in Table 8.
**Table 8 — Coding of the stuff count**

|  | Value |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Number of stuff bits modulo 8 | 0d | 1d | 2d | 3d | 4d | 5d | 6d | 7d |
| SBC (Gray-coded with parity bit) | 0000b | 0011b | 0110b | 0101b | 1100b | 1111b | 1010b | 1001b |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | SBC FCRC sequence |  |  |  |  |  |  |  |
| SBC(3) | SBC(2) | SBC(1) | SBC(0) | Bit(16) Bit(15) Bit(1) Bit(0) |  |  |  | CRC delimiter |

**Figure 22 — CRC field in FD frame using CRC\_17**

| CRC field |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | SBC FCRC sequence |  |  |  |  |  |  |  |
| SBC(3) | SBC(2) | SBC(1) | SBC(0) | Bit(20) Bit(19) Bit(1) Bit(0) |  |  |  | CRC delimiter |

**Figure 23 — CRC field in FD frame using CRC\_21**
...
The data length code shall be an 11-bit value in the range of 0 to 2047d; it shall be passed from the LLC frame. The length of the data field shall be in the range from 1 byte to 2048 bytes. The actual length of the data field shall be one byte more than the value of the DLC.
EXAMPLE A 128-byte MAC data field is indicated by a DLC of 127.

## **SBC**

The stuff bit count shall be a 3-bit value, giving information on the number of dynamic stuff bits in the arbitration field. The SBC represents a number in the range from 0 to 3d (gray-coded in SBC2 and SBC1 followed by the parity bit SBC0) as specified in Table 9.
**Table 9 — Coding of the SBC**

|  | Value |  |  |  |
| --- | --- | --- | --- | --- |
| Number of stuff bits | 0d | 1d | 2d | 3d |
| SBC (Gray-coded with parity bit) | 001b | 010b | 111b | 100b |
...
| Destuffed bit stream | 01011111010b | 10100000101b | 01011111000010b | 10100000111101b |
| --- | --- | --- | --- | --- |
| Stuffed bit stream | 01011111o010b | 10100000i101b | 01011111o0000i10b | 10100000i1111o01b |
...
![Image](_page_52_Figure_8.jpeg)
**Figure 28 — CRC error in CC frames**

![Image](_page_52_Figure_10.jpeg)
...
* a) LLC-requested OF (initiated by the LLC sub-layer): An LLC may cause an OF transmission, when internal conditions of the receiver need a delay of the next MAC DF or MAC RF.
...
a) The PCS shall encompass functions related to bit encoding/decoding, timing and synchronization as well as bus failure detection. They are specified in the subsequent subclauses.
...
The PCS\_Mode.Request service is passed from the MAC sub-layer to the PCS to indicate that the MAC sublayer transmits or receives an XL frame. The service shall provide the following parameter:
...
The PCS\_Status.Receiver service is passed from the MAC sub-layer to the PCS to indicate that the MAC sublayer receives the FD data phase of an FD frame or that part of an XL frame in which the transceiver is switched into the data RX mode when the CAN transceiver mode switching is enabled. The service shall provide the following parameter.
...
NOTE When the following expression is true, it means that the transceiver has to operate in data RX mode: (PCS\_ Mode.Request(XL\_Mode) = active) AND (PCS\_Status.Receiver(D\_Receive) = active).
...
* a) the same time quantum length is used in the nominal bit time and in the data bit time;
* b) the positions of the sample points in the nominal bit time are the same in all CAN nodes of a network:
* c) the positions of the sample points in the FD data bit time are the same in all CAN nodes of a network.
...
The information processing time shall be the number of time quanta required for the calculation of the subsequent bit level. This calculation begins at the sample point and shall be less than or equal to Phase\_ Seg2 (see 7.3.5 for additional restrictions).
...
The internal delay time of a CAN node, *t*node, shall be the sum of all asynchronous delays that occur along the transmission and reception path, relative to the bit timing logic unit of the CAN node. For more details see Figure 33.

![Image](_page_59_Figure_8.jpeg)
...
$$t_{\text{node}} = t_{\text{output}} + t_{\text{input}} \tag{1}$$
— for proper arbitration, the following conditions given by Formula (2) shall be met:
$$t_{\text{prop seg}} \ge t_{\text{node A}} + t_{\text{node B}} + 2 \times t_{\text{busline}}$$
 (2)
— the leading transmitting bit timing logic with respect to synchronization of CAN, node A, shall be able to know the correct bus level of bit n at the sampling point. The tolerable values of  $t_{\rm node}$  depend on the required bit rate and line length of the bus (maximum distance between any two nodes) and of the possible bit timing as shown by the arbitration condition.

#### 7.3.3 Configuration of the bit time parameters

Configuration of the bit time shall be performed using the following periods of time: Sync\_Seg, Prop\_Seg, Phase\_Seg1, Phase\_Seg2, and SJW. All parameters are representing integer number of the  $t_{\rm q}$  based on the  $t_{\rm q,min}$  and the prescaler m. For nodes that support FD or XL frame formats, the configuration range of the SSP offset, representing integer number of the  $t_{\rm q,min}$ , is also specified.
...
| Sync_Seg | 1 t q |
| Prop_Seg | 1 to 8 t q |
| Phase_Seg1 | 1 to 8 t q |
| Phase_Seg2 | 2 to 8 t q |
| SJW | 1 to 4 t q |

Table 12 — Time segments minimum configuration ranges when XL frame format is not supported

|  | Separate prescalers | Shared prescalers | Separate or shared |
| --- | --- | --- | --- |
| Parameter | Nominal bit time | Nominal bit time | FD data bit time |
| Prescaler m | 1 to 32 | 1 to | 32 |
| Sync_Seg | 1 t q | 1 t q | 1 t q |
| Prop_Seg | 1 to 48 t q | 0 to 96 t q | 0 to 8 t q |
| Phase_Seg1 | 1 to 16 t q | 1 to 32 t q | 1 to 8 t q |
| Phase_Seg2 | 2 to 16 t q | 2 to 32 t q | 2 to 8 t q |
| SJW | 1 to 16 t q | 1 to 32 t q | 1 to 8 t q |
| SSP offset | not applicable | not applicable | 1 to 63 t q.min |

For nodes that support the FD frame format but not the XL frame format, the values given in  $\frac{\text{Table }13}{\text{Log}}$  should be used.  $\frac{\text{Table }12}{\text{Log}}$  is provided to enable implementations of FD nodes that comply with ISO 11898-1:2015 to be compliant with this document.
...
| Prescaler m |  | 1 to 32 |  |
| Sync_Seg | 1 t q | 1 t q | 1 t q |
| Prop_Seg | 1 to 384 t q | 0 to 128 t q | 0 to 128 t q |
| Phase_Seg1 | 1 to 128 t q | 1 to 128 t q | 1 to 128 t q |
| Phase_Seg2 | 2 to 128 t q | 2 to 128 t q | 2 to 128 t q |
| SJW | 1 to 128 t q | 1 to 128 t q | 1 to 128 t q |
| SSP offset | not applicable | 1 to 160 t q.min | 1 to 160 t q.min |

The following restrictions apply for the configuration of the bit time segments.
* The information processing time shall be less than or equal to 2  $t_0$  long.
...
The node shall be able to compensate transmitter delays of at least 95  $t_{\rm q.min}$ . The position of the SSP shall be configurable separately for XL frames and for FD frames.
...
NOTE The latest SSP is 160+95=255  $t_{\rm q.min}$  after the start of the transmitted bit, when the minimum configuration ranges are used. With these minimum configuration ranges, assuming an  $t_{\rm q.min}$  duration of 6,25 ns (160 MHz), a transmitter delay of 95  $t_{\rm q.min}$  × 6,25 ns/  $t_{\rm q.min}$  = 593,75 ns can be compensated and the SSP offset can be set to 160  $t_{\rm q.min}$  × 6,25 ns/  $t_{\rm q.min}$  = 1 000 ns.
...
Transmitted bits A B C D E CRC delimiter
SP sequence  $SP_A SP_B SP_C SP_D SP_E SP_{CRCdel} SP_{CRCdel1} SP_{Error}$ Transmitted bits  $_{2 \text{ bit delay}}$   $A_2 B_2 C_2 D_2 E_2 CRC$  delimiter  $_2$ Received bits  $A_R B_R C_R D_R E_R CRC_{delR}$ SSP sequence  $SP_A SSP_B SSP_C SSP_D SSP_E SSP_{CRCdelR}$
...
The state machine synchronizing the operation of the CAN node to the PCS\_Data.Indicate shall operate in time steps of one  $t_{\rm q}$ . At each time quantum, it shall be analysed whether the bus state is recessive or dominant. The bus state detected at the sample point of a bit shall be regarded as the value of that bit. A difference in
...
The tolerance of a node clock oscillator frequency  $f_{\rm osc}$  around the nominal frequency  $f_{\rm nom}$  shall be given by the range  $(1-{\rm d}f)\times f_{\rm nom}\le f_{\rm osc}\le (1+{\rm d}f)\times f_{\rm nom}$ . The tolerance  ${\rm d}f$  depends on the length of the  $t_{q}$ , the segments of the bit time  $t_{\rm bit}$ , and on the SJW. The maximum difference between the node clock oscillators of any two nodes is expected to be  $2\times {\rm d}f\times f_{\rm nom}$ .
The maximum tolerance df of  $f_{osc}$  shall meet the following conditions:
$$df < \frac{SJW(N)}{2 \times 10 \times tbit(N)} \tag{3}$$
$$df < \frac{min[Phase\_Seg1(N), Phase\_Seg2(N)]}{2 \times [13 \times tbit(N) - Phase\_Seg2(N)]}$$
(4)
$$df < \frac{SJW(D)}{2 \times 10 \times tbit(D)} \tag{5}$$
$$df < \frac{min[Phase\_Seg1(N), Phase\_Seg2(N)]}{2 \times \left[ [6 \times tbit(D) - Phase\_Seg2(D)] \times \frac{m(D)}{m(N)} + 7 \times tbit(N) \right]}$$
$$(6)$$
$$df < \frac{SJW(D) - max\left(0, \frac{m(N)}{m(D)} - 1\right)}{2 \times \left[\left[2 \times t \operatorname{bit}(N) - Phase \_Seg2(N)\right] \times \frac{m(N)}{m(D)} + Phase \_Seg2(D) + 4 \times t \operatorname{bit}(D)\right]}$$
$$(7)$$
where
...
$$df < \frac{SJW(X)}{2 \times (2S+1) \times tbit(X)} \tag{8}$$
...
This interface is between the PCS as specified in  $\overline{7.3}$  and the PMA sub-layer specified in other ISO standards (e.g. in ISO 11898-2 and ISO 11992-1).
...
The PWM encoding function encodes the PCS signals towards the AUI allowing to control the physical behaviour of the PMA sub-layer implicitly through the output bit stream. The CAN SIC XL transceiver, as specified in ISO 11898-2, supports two different bus driver and bus comparator characteristics depending on the phases of the protocol as specified in  $\underline{5.16}$ .
...
The CAN transceiver mode switching is initiated and maintained through the PWM encoding function. A PWM symbol encoding with a certain period time that lies within the minimum and maximum of the PWM detection time  $t_{\rm SymbolNom}$  as specified in ISO 11898-2:2024, Table 12, is used to switch the PMA sub-layer from the arbitration mode with the dominant-and-recessive characteristic towards the data TX mode or the data RX mode with the level\_0 and level\_1 bit driven through a push-pull characteristic.
...
The PWM symbol time is an integer multiple of the  $t_{\rm q.min}$  and is independent of a configured bit rate prescaler. PWM coding guidelines are given in the CiA 612-2 document.

![Image](_page_68_Figure_2.jpeg)
Figure 37 — PWM symbol coding definitions, example for the transmitter

![Image](_page_68_Figure_4.jpeg)
...
The PWM-encoded signal towards the PMA sub-layer shall have an internal processing delay of 0  $t_{\rm q.min}$  or 1  $t_{\rm q.min}$  relative to the DLL bit boundaries. The internal processing delay shall be of constant length and shall impact identically both, the activation and the deactivation of the PWM encoding. This delay is compensated by the receiving nodes synchronizing on the edge to the DL1 bit.
If a processing delay of 1  $t_{\rm q.min}$  is used, then the signal towards the PMA sub-layer shall remain at its value for this 1  $t_{\rm q.min}$  between the signalling of the activation and the actual activation of the PWM encoding. The processing delay of 1  $t_{\rm q.min}$  after deactivation of the PWM encoding shortens DAH bit by 1  $t_{\rm q.min}$ .

##### 7.5.3.3 PWM configuration

The PWM short and long phases are integer multiples of the one  $t_{\rm q.min}$ . PWM symbol lengths of 200 ns (nominal length) or shorter than shall be supported. The required minimum PWM configuration depth n depends on the length of one  $t_{\rm q.min}$  and shall follow Formula (9):
$$n > tPWM_nom_max \times \frac{1}{t_{q.min}}$$
 (9)
The length of  $t_{PWM nom max}$  is 200 ns.
The PWM short phase length (PWMS) shall be configurable supporting a range of at least 1 to n-1  $t_{\rm q.min}$ . The PWM long phase length (PWML) shall be configurable supporting a range of at least 1 to n-1  $t_{\rm q.min}$ . The PWM symbol length is the sum of PWMS and PWML.
The parameter PWM time offset (PWMO) shall be configurable supporting a range of at least 0  $t_{\rm q.min}$  to n-1  $t_{\rm q.min}$  used to delay the start of the PWM encoding at the beginning of the ADH bit compensating for odd bit length relations between the arbitration phase and the XL data phase for transmitter. PWMO shall always be smaller than the sum of PWMS and PWML.
...
If the service parameter PCS\_Status.Transmitter (D\_Transmit) is passive or if the service parameter PCS\_ Mode.Request (XL\_Mode) is passive, the PCS output symbols shall be directly forwarded to the PMA sublayer regardless of the actual PWM phase.
...
| Counters_unchanged | Indicates that the FCE counters remain unchanged (due to special cases; see rule c) in 8.1.4.2). |
...
* c) When a transmitter sends an error flag, the transmit error counter shall be incremented by 8. Exception 1:
  * If the transmitter is error-passive and detects an ACK error because of not detecting a dominant ACK and does not detect a dominant bit while sending its passive error flag. Exception 2:
...
![Image](_page_76_Figure_1.jpeg)
**Key**
EA error active
EP error passive
BO bus-off
T1 init (Normal\_Mode\_Request)
...
T5 Normal\_Mode\_Request AND 128 occurrences of 11 consecutive recessive bits
**Figure 43 — Node status transition diagram**
...
| DLC | 4 bit | data length code, as specified in Table 5 |
...
The tolerance of a responder node clock oscillator frequency  $f_{\rm osc}$  around the nominal frequency  $f_{\rm nom}$  shall be given by the range
$$(1-df)^* f_{\text{nom}} \le f_{\text{osc}} \le (1+df)^* f_{\text{nom}}$$
 (A.1)
...
$$\left(\mathrm{d}f_{\mathrm{commander}} + \mathrm{d}f_{\mathrm{responder}}\right) * f_{\mathrm{nom}} \tag{A.2}$$
where  $df_{commander}$  is the frequency tolerance of the commander node and  $df_{responder}$  is the frequency tolerance of the responder node.
The maximum tolerance  $df_{responder}$  of  $f_{osc}$  shall meet the following condition:
$$df_{\text{responder}} < \frac{SJW}{10*t_{\text{bit}}(N)} - df_{\text{commander}}$$
(A.3)
or in case only hard synchronization is supported:
$$Phase\_Seg\_min = min(Phase\_Seg1, Phase\_Seg2)$$
(A.4)
$$df_{responder} < \frac{Phase\_Seg\_min}{10*tbit(N)} - df_{commander}$$
(A.5)
...
Responder nodes shall not support the node status transition diagram as specified in  $\underline{\text{Figure 43}}$  and the error counter as specified in  $\underline{8.1.4}$ .
...
| --- | --- |
| Retransmission counter | 6.5.3 |
| Restricted operation | 6.6.19 |
| Arbitration on FDF bit | 6.6.11.2 |
| Time segments minimum configuration ranges | 7.3.3 |
| Transmitter delay compensation range | 7.3.4 |
| Edge filtering during integration | 7.3.5.3 |
...
![Image](_page_89_Picture_0.jpeg)
**ICS 43.040.15**
Price based on 82 pages
© ISO 2024 **iso.org** All rights reserved
