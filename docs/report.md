...
The implementation language is VHDL-2008 and the verification framework is OSVVM [@osvvm], both mandated by Everllence's VHDL Code Standard. SystemVerilog with UVM is the dominant industry alternative for RTL implementation and verification at this scale; the choice here follows company convention rather than a project-level technical comparison. GHDL [@ghdl] is used for simulation.
