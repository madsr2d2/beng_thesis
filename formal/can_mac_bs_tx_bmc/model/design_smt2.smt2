...
; yosys-smt2-anyinit can_mac_bs_tx#13 7 :377
...
; yosys-smt2-anyinit can_mac_bs_tx#15 3 :378
...
; yosys-smt2-anyinit can_mac_bs_tx#16 3 :384
...
; yosys-smt2-anyinit can_mac_bs_tx#17 2 :379
...
; yosys-smt2-anyinit can_mac_bs_tx#18 1 :382
...
; yosys-smt2-anyinit can_mac_bs_tx#20 3 :380
...
; yosys-smt2-anyinit can_mac_bs_tx#21 3 :383
...
; yosys-smt2-anyinit can_mac_bs_tx#22 1 :381
...
(define-fun |can_mac_bs_tx#23| ((state |can_mac_bs_tx_s|)) (_ BitVec 1) (bvnot (ite (|can_mac_bs_tx#14| state) #b1 #b0))) ; $auto$rtlil.cc:3339:Not$164
; yosys-smt2-assume 0 $auto$formalff.cc:987:execute$165
(define-fun |can_mac_bs_tx_u 0| ((state |can_mac_bs_tx_s|)) Bool (or (= ((_ extract 0 0) (|can_mac_bs_tx#23| state)) #b1) (not true))) ; $auto$formalff.cc:987:execute$165
...
(define-fun |can_mac_bs_tx_t| ((state |can_mac_bs_tx_s|) (next_state |can_mac_bs_tx_s|)) Bool (and
  (= (|can_mac_bs_tx#99| state) (|can_mac_bs_tx#22| next_state)) ; :381 \stuff_valid_prev
  (= (|can_mac_bs_tx#100| state) (|can_mac_bs_tx#21| next_state)) ; :383 \stuff_count_prev
  (= (|can_mac_bs_tx#118| state) (|can_mac_bs_tx#20| next_state)) ; :380 \stuff_count
  (= (|can_mac_bs_tx#119| state) (|can_mac_bs_tx#18| next_state)) ; :382 \reset_done
  (= (|can_mac_bs_tx#121| state) (|can_mac_bs_tx#17| next_state)) ; :379 \last_polarity
  (= (|can_mac_bs_tx#122| state) (|can_mac_bs_tx#16| next_state)) ; :384 \consecutive_count_prev
  (= (|can_mac_bs_tx#124| state) (|can_mac_bs_tx#15| next_state)) ; :378 \consecutive_count
  (= (|can_mac_bs_tx#129| state) (|can_mac_bs_tx#13| next_state)) ; :377 { \bs_o[sbc] \bs_o[valid] \bs_o[data] }
  (= (|can_mac_bs_tx#135| state) (|can_mac_bs_tx#8| next_state)) ; $auto$ff.cc:337:slice$160 $auto$ghdl.cc:846:import_module$94 [1]
  (= (|can_mac_bs_tx#98| state) (|can_mac_bs_tx#6| next_state)) ; $auto$ff.cc:337:slice$159 $auto$ghdl.cc:846:import_module$47 [1]
  (= #b0 (|can_mac_bs_tx#4| next_state)) ; :170 $auto$ghdl.cc:846:import_module$44 [0]
  (= (|can_mac_bs_tx#137| state) (|can_mac_bs_tx#2| next_state)) ; $auto$ff.cc:337:slice$162 $auto$ghdl.cc:846:import_module$121 [1]
  (= (|can_mac_bs_tx#139| state) (|can_mac_bs_tx#0| next_state)) ; $auto$ff.cc:337:slice$161 $auto$ghdl.cc:846:import_module$109 [1]
